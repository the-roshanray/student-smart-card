...
const CanteenPage = ({ params }) => {
  ...
  const handleChange = (e) => {
    ...
    setNewItem((prev) => ({
      ...prev,
      [name]: name === "plate" || name === "amount" ? Number(value) : value,
    }));
  };
  ...
  const handleAddItem = () => {
    if (
      ...
      setNewItem({ code: "", name: "", plate: 0, amount: 0 });
    } else {
        ...
        <div className="flex items-center gap-2">
          {loading ? (
            ...
            <>
              ...
              />
              <button
                className="bg-blue-500 text-white rounded-md px-4 py-2 flex items-center gap-2"
